...
if __name__ == "__main__":
    ...
    old_name = "basic_locomotion_dls_isaaclab"
    new_name = sys.argv[1]
    ...
    if proceed.lower() == "y":
        # rename the basic_locomotion_dls_isaaclab folder
        os.rename(
            os.path.join(root_dir_path, "source", "basic_locomotion_dls_isaaclab", "basic_locomotion_dls_isaaclab"),
            os.path.join(root_dir_path, "source", "basic_locomotion_dls_isaaclab", new_name),
        )
        os.rename(
            os.path.join(root_dir_path, "source", "basic_locomotion_dls_isaaclab", new_name), os.path.join(root_dir_path, "source", "basic_locomotion_dls_isaaclab", new_name)
        )
