...
@configclass
class PegasusFlatEnvCfg(DirectRLEnvCfg):
    # env
    ...
    observation_space += 12 # joint status
    ...
    use_rma = False
    if(use_rma):
        rma_network_type = "tcn" # "mlp" or "tcn"
    ...
    # robot
    robot: ArticulationCfg = PEGASUS_CFG.replace(prim_path="/World/envs/env_.*/Robot")
    ...
    # Desired front-hip height above local terrain (used for two_legs front-hip tracking)
    desired_front_hip_height = 0.45
    ...
    rl_calf_failed = 0
    rr_calf_failed = 0
    fl_hip_thigh_failed = 0
    fr_hip_thigh_failed = 0
    rl_hip_thigh_failed = 0
    rr_hip_thigh_failed = 0
    fl_hip_calf_failed = 0
    fr_hip_calf_failed = 0
    rl_hip_calf_failed = 0
    ...
    failure_type_activation = [
                        ...
                        fl_calf_failed, fr_calf_failed, rl_calf_failed, rr_calf_failed,
                        fl_hip_thigh_failed, fr_hip_thigh_failed, rl_hip_thigh_failed, rr_hip_thigh_failed,
                        fl_hip_calf_failed, fr_hip_calf_failed, rl_hip_calf_failed, rr_hip_calf_failed,
                        fl_all_failed, fr_all_failed, rl_all_failed, rr_all_failed
                        ]
    ...
    # Two legs fault specifi command
    two_legs_front_hip_height_reward_scale = 1.0


import isaaclab.terrains as terrain_gen
from isaaclab.terrains.terrain_generator_cfg import TerrainGeneratorCfg
@configclass
class PegasusRoughBlindEnvCfg(PegasusFlatEnvCfg):
    ...
    ROUGH_TERRAINS_CFG = TerrainGeneratorCfg(
        ...
        sub_terrains={
            ...
            "pyramid_stairs": terrain_gen.MeshPyramidStairsTerrainCfg(
                proportion=0.15, step_height_range=(0.02, 0.10), step_width=0.3,
...
@configclass
class PegasusRoughVisionEnvCfg(PegasusRoughBlindEnvCfg):
