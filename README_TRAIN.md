...
```bash
python scripts/rsl_rl/train.py --task=Commando-Go2-Flat --num_envs=4096 --headless
python scripts/rsl_rl/train.py --task=Commando-Go2-Rough-Blind --num_envs=4096 --headless
python scripts/rsl_rl/train.py --task=Commando-Go2-Rough-Vision --num_envs=4096 --headless
```
...
```bash
python scripts/rsl_rl/play.py --task=Commando-Go2-Flat --num_envs=16
...
```bash
python3 ../mixture_of_expert_recovery_isaaclab/exts/mixture_of_expert_recovery_isaaclab/mixture_of_expert_recovery_isaaclab/hyperparameter_tuning/tuner.py --run_mode local --cfg_file ../mixture_of_expert_recovery_isaaclab/exts/mixture_of_expert_recovery_isaaclab/mixture_of_expert_recovery_isaaclab/hyperparameter_tuning/locomotion_aliengo_cfg.py --cfg_class LocomotionAliengoFlatTuner (TERMINAL 2)
```
...
```bash
./isaaclab.sh -p scripts/tools/convert_mjcf.py   ../mixture_of_expert_recovery_isaaclab/scripts/sim_to_sim_mujoco/gym-quadruped/gym_quadruped/robot_model/aliengo/aliengo.xml   ../aliengo.usd   --import-sites   --make-instanceable
```
